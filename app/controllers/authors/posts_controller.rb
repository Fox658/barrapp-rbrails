  ...
  class PostsController < AuthorController
    ...
    def create
      ...
      respond_to do |format|
        if @post.save
          format.html { redirect_to authors_post_path(@post), notice: 'El post fue creado exitosamente.' }
    ...
    def update
      respond_to do |format|
        if @post.update(post_params)
          format.html { redirect_to authors_post_path(@post), notice: 'El post fue actualizado.' }
    ...
    def destroy
      @post.destroy
      respond_to do |format|
        format.html { redirect_to authors_posts_url, notice: 'El post fue Eliminado.' }
